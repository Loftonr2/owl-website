/**
 * Blog seed data ΓÇö category definitions and article archive.
...
export const SEED_BLOG_CATEGORIES: SeedBlogCategory[] = [
  ...
  },
  {
    ...
    name: "Music & Learning",
    description: "Why music is the most powerful early-learning tool ΓÇö and how to use it every day.",
    hero: "Music & learning",
    icon: "≡ƒÄ╡",
  },
  {
  ...
  },
  {
    ...
    description: "Keeping children safe, healthy, and emotionally well ΓÇö body, mind, and spirit.",
...
export const SEED_BLOG_ARTICLES: SeedBlogArticle[] = [
  {
    ...
    category: "activities",
    summary: "A 100-word framework for telling a small child about light, family, and welcoming neighbors during Diwali ΓÇö without overwhelming them.",
    body: "Diwali is the festival of lights ΓÇö a five-day celebration shared by Hindus, Sikhs, Jains, and Buddhists across the world. When a three-year-old asks 'what is Diwali?', the best answer is a small one. Say: 'It's a time when families light little lamps called diyas and welcome each other home.' Then point at a candle. Sing a song. Make a paper diya together. Children don't need theology at three ΓÇö they need a sensory memory and a kind feeling. That's how a holiday becomes part of their internal map.",
    author: "Larissa",
  ...
  },
  {
    ...
    category: "activities",
    summary: "Seven hands-on Kwanzaa activities calibrated for ages 3ΓÇô5 ΓÇö no special materials required.",
    body: "Kwanzaa is observed Dec 26ΓÇôJan 1 and centers seven principles (Nguzo Saba): unity, self-determination, collective work, cooperative economics, purpose, creativity, and faith. For preschoolers, focus on one principle per day. Day 1 (umoja / unity): make a community handprint mural. Day 2 (kujichagulia / self-determination): each child shares one thing they did themselves this week. Day 3 (ujima / collective work): a group cleanup activity. The point is participation, not perfection ΓÇö these are introductions, not lectures.",
    author: "Larissa",
  ...
  },
  {
    ...
    summary: "The neuroscience of repetition: why your toddler asks for the same song forty times ΓÇö and why that's perfect.",
    body: "Repetition strengthens myelination ΓÇö the insulating layer around neural pathways. A song heard forty times isn't a song heard forty times; it's the same song laid down in forty slightly different brain states, building robust recall. Children don't ask for repetition because they're stuck. They're asking because the song is doing exactly what their brain needs. Sing it again. Sing it the way they like it. The repetition is the lesson.",
    author: "Larissa",
  ...
  },
  {
    ...
    body: "Download our free Hanukkah coloring page (ages 3ΓÇô7). The page includes a hand-drawn menorah, a dreidel, a small Star of David, and four lines of plain-language explanation that you can read together. Print on regular paper. Use the conversation prompts on the back to talk about light, history, and family. No religious instruction ΓÇö just a gentle, factual introduction.",
    author: "Larissa",
  ...
  },
  {
    ...
    summary: "A curated list of free + low-cost multicultural resources for KΓÇô3 classrooms.",
    body: "Multicultural classrooms aren't built from a single book ΓÇö they're built from dozens of small daily choices: who's on the wall, whose names are pronounced correctly, what music plays during transitions. This list groups free resources by subject: literacy, math, history, music, and SEL. Most are free; the rest are under $20. Standards alignments noted where applicable.",
    author: "Larissa",
